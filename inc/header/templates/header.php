...
if ( is_singular( 'post' ) ) {
	$skin = 'class="qodef-content-grid qodef-skin--light qodef-header-cursor--light"';
} else {
	$skin = '';
}
...
<header id="qodef-page-header" <?php globefarer_class_attribute( apply_filters( 'globefarer_filter_header_class', array() ) ); ?> role="banner">
	...
	?>
	<div id="qodef-page-header-inner" <?php echo $skin; ?> <?php globefarer_class_attribute( apply_filters( 'globefarer_filter_header_inner_class', array(), 'default' ) ); ?>>
		<?php

...
if ( ! function_exists( 'globefarer_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function globefarer_get_filter_items( $params ) {
		...
		return apply_filters( 'globefarer_filter_get_filter_items', $items, $params );
	}
}
